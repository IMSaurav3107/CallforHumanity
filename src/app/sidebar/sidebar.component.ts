...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/maps',          title: 'Locate Donors',              icon:'nc-pin-3',      class: '' , type:'government'},
    { path: '/maps',          title: 'Locate Entities',              icon:'nc-pin-3',      class: '' , type:'donor'},
    { path: '/icons',         title: 'Category',             icon:'nc-box',    class: '' , type:'donor'},
